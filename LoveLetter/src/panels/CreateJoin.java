...
public class CreateJoin extends JPanel{
	...
	private void addBackgroundLabel() {
		...
		ImageIcon back = new ImageIcon(GameSelection.class.getResource("/images/gameMode/createJoin.png"));
	...
	private void addBackButton() {
		ImageIcon backIcon = new ImageIcon(GameSelection.class.getResource("/images/gameMode/back2.png"));
	...
	private void addCreateButton() {
		...
		ImageIcon createIcon = new ImageIcon(GameSelection.class.getResource("/images/gameMode/create.png"));
	...
	private void addJoinButton() {
		...
		ImageIcon joinIcon = new ImageIcon(GameSelection.class.getResource("/images/gameMode/join.png"));
